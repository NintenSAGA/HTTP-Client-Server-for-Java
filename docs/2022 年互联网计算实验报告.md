...
| PC   | RJ45           | Console  |
| ---- | -------------- | -------- |
| 0    | `192.168.10.2` | Switch A |
| 1    | `192.168.20.2` | Switch B |
| 2    | `192.168.40.2` | Router D |
| 3    | `192.168.60.2` | Router C |
| 4    | `192.168.30.2` | Router A |
| 5    | `192.168.10.4` | Router B |

| Switch | Trunk       | Access VLAN10 | Access VLAN20 |
| ------ | ----------- | ------------- | ------------- |
| A      | F0/1, F0/24 | F0/2          | F0/23         |
| B      | F0/24       | F0/2, F0/3    | F0/23         |
...
- PC4(192.168.30.2) <-> PC2(102.168.40.2)
- PC3(192.168.60.2) <-> PC0(102.168.10.2)
- PC1(192.168.20.2) <-> PC5(102.168.10.4)
