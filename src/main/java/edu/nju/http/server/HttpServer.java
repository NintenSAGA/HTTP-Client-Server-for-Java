...
import static edu.nju.http.message.consts.Headers.ACCEPT_ENCODING;
import static edu.nju.http.message.consts.Headers.CONNECTION;
import static edu.nju.http.message.consts.Headers.KEEP_ALIVE;
