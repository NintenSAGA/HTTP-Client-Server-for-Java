...
import edu.nju.http.message.parser.contentdecode.ContentDecodeStrategy;
import edu.nju.http.message.parser.contentdecode.ContentGzipDecodeStrategy;
import edu.nju.http.message.parser.transdecode.TransChunkedDecodeStrategy;
import edu.nju.http.message.parser.transdecode.TransContentLengthDecodeStrategy;
import edu.nju.http.message.parser.transdecode.TransDecodeStrategy;
...
import static edu.nju.http.message.consts.Headers.content_encoding;
...
public class MessageParser {
    ...
    private void strategyInit() {
        ...
        transDecodeStrategyMap.put( content_length,    new TransContentLengthDecodeStrategy() );
        transDecodeStrategyMap.put( CHUNKED,           new TransChunkedDecodeStrategy() );

        contDecodeStrategyMap = new HashMap<>();
        contDecodeStrategyMap.put( GZIP, new ContentGzipDecodeStrategy() );
    }
